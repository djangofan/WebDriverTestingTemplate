 ...
 *
 */
public class TestHandleCacheThree extends MultiWinCacheUtils {

	/**
	 *  Setup web server before loading class
	 */
	@BeforeClass
	public static void setUpTestHandleCacheThreeClass() {
	...
	public TestHandleCacheThree() {
		logger.info("Constructed TestHandleCacheThree");
	}
	...
	public void setUpTestHandleCacheThree() {
		logger.info("Finished setUpTestHandleCacheThree");
	}
	 ...
	 */
	@Test
	public void testHandleCacheThree() {
		logger.info("Starting test testHandleCacheThree" );
		...
		logger.info( "Finished testHandleCacheThree" );
	}	
	 ...
	 */
	@After
	public void tearDownTestHandleCacheThree() {
		// close main window handle
		driver.switchTo().window( mainHandle );
		driver.get("about:about");
		updateHandleCache();  
		waitTimer(6, 500);
		logger.info("Finished tearDownTestHandleCacheThree");
	}
	 ...
	 */
	@AfterClass
	public static void tearDownTestHandleCacheThreeClass() {
